...
- `--mutation-file`: CSV file specifying specific mutations to score (expects rows of `protein_id,mutation_id`). If not provided, the whole single-site mutational landscape of all input proteins will be scored.
