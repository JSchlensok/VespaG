...
def mask_non_mutations(gemme_prediction: Float[torch.Tensor, "length 20"], wildtype_sequence) -> Float[torch.Tensor, "length 20"]:
    """
...
def compute_mutation_score(y: Float[torch.Tensor, "length 20"], mutation: Union[Mutation, SAV], alphabet: str=AMINO_ACIDS) -> float:
